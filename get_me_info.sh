...
do
  ...
  aws ec2 describe-instances --instance-ids $instance --profile habitat --region us-west-2  | jq ['.Reservations[].Instances[] | .InstanceId, .InstanceType, .PublicDnsName, .PublicIpAddress']
  echo
